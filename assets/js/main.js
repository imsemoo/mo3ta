...
(function () {
  ...
  var DATA = {
    ...
    heroKpis: [
      { label: 'شهداء',            target: 1581,  ic: 'person', tone: 'casualties', href: 'daily_mo3ta.html' },
      { label: 'إصابات',           target: 36776, ic: 'aid',    tone: 'casualties', href: 'daily_mo3ta.html' },
      { label: 'اعتقالات',         target: 54385, ic: 'lock',   tone: 'violations', href: 'daily_mo3ta.html' },
      { label: 'منازل مهدّمة',     target: 10951, ic: 'house',  tone: 'violations', href: 'daily_mo3ta.html' },
      { label: 'مقاومة شعبية',     target: 55516, ic: 'flag',   tone: 'resistance', href: 'daily_mo3ta.html' },
      { label: 'عمليات نوعية',     target: 8217,  ic: 'target', tone: 'resistance', href: 'daily_mo3ta.html' }
    ],
    GOV: [
    ...
    CAL_EVENTS: {
      '2025-10-2':  [
        { t: '16 شهيداً و248 جريحاً في 7,514 انتهاكاً إسرائيلياً في الضفة والقدس خلال سبتمبر 2025', tag: 'تقرير دوري', img: 'assets/img/reports/report-1.webp', gov: 'الضفة والقدس' },
        { t: 'رواية مصوّرة: أبرز محطّات الحصاد الميداني خلال سبتمبر', tag: 'رواية مصوّرة', gov: 'الضفة والقدس' }
      ],
      '2025-10-1':  [
        { t: '10 قتلى و51 جريحاً إسرائيلياً — عمليات نوعية تهزّ الاحتلال في الضفة والقدس خلال سبتمبر 2025', tag: 'تقرير دوري', img: 'assets/img/reports/report-2.webp', gov: 'الضفة والقدس' }
      ],
      '2025-9-18':  [
        { t: 'تقرير خاص — الحواجز والبوابات الحديدية: تقطيعٌ لأوصال الضفة الغربية', tag: 'تقرير خاص', img: 'assets/img/reports/special-1.webp', gov: 'الضفة الغربية' }
      ],
      '2025-9-10':  [
        { t: 'رصد ميداني: تصاعد اقتحامات المستوطنين للمسجد الأقصى خلال الأسبوع', tag: 'رصد ميداني', gov: 'القدس' }
      ],
      '2025-9-2':   [
        { t: '7 شهداء و183 جريحاً في 6,009 انتهاكاً إسرائيلياً في الضفة والقدس خلال أغسطس 2025', tag: 'تقرير دوري', img: 'assets/img/reports/report-3.webp', gov: 'الضفة والقدس' },
        { t: 'إنفوغرافيك: توزيع الانتهاكات على المحافظات خلال أغسطس', tag: 'إنفوغرافيك', gov: 'الضفة والقدس' }
      ],
      '2025-9-1':   [
        { t: '7 جرحى إسرائيليين و263 عملاً مقاوماً في الضفة الغربية خلال أغسطس 2025', tag: 'تقرير دوري', img: 'assets/img/reports/report-4.webp', gov: 'الضفة الغربية' }
      ],
      '2025-8-5':   [
        { t: 'تقرير: حصيلة الاعتقالات في الضفة الغربية منذ بداية العام', tag: 'تقرير دوري', gov: 'الضفة الغربية' }
      ],
      '2025-8-2':   [
        { t: 'الحصاد الشهري الموثّق لانتهاكات الاحتلال في الضفة والقدس خلال يوليو 2025', tag: 'تقرير دوري', img: 'assets/img/reports/report-3.webp', gov: 'الضفة والقدس' }
      ],
      '2025-7-15':  [
        { t: '60,758 اقتحاماً و54,385 اعتقالاً — حصيلة انتهاكات الاحتلال التراكمية في الضفة', tag: 'تقرير دوري', img: 'assets/img/reports/report-1.webp', gov: 'الضفة الغربية' }
      ],
      '2025-7-2':   [
        { t: '9 شهداء و210 جرحى في 5,840 انتهاكاً إسرائيلياً خلال يونيو 2025', tag: 'تقرير دوري', img: 'assets/img/reports/report-1.webp', gov: 'الضفة والقدس' }
      ],
      '2025-6-20':  [
        { t: 'حراكات وأعمال مقاومة شعبية: 55,516 فعلاً موثّقاً في الضفة الغربية', tag: 'تقرير دوري', img: 'assets/img/reports/report-4.webp', gov: 'الضفة الغربية' }
      ],
      '2025-6-12':  [
        { t: 'رصد خاص: ملاحقة الفلسطينيين في الداخل المحتل عام 1948', tag: 'تقرير خاص', img: 'assets/img/reports/special-1.webp', gov: 'أراضي 48' }
      ],
      '2025-5-22':  [
        { t: 'تقرير خاص: المستوطنون والاعتداءات الممنهجة على القرى الفلسطينية', tag: 'تقرير خاص', img: 'assets/img/reports/special-3.webp', gov: 'الضفة الغربية' }
      ],
      '2025-2-1':   [
        { t: 'تقرير خاص: الشعارات التي ظهرت على منصّة تسليم الأسرى في صفقة التبادل الرابعة', tag: 'تقرير خاص', img: 'assets/img/reports/special-2.webp', gov: 'غزة' }
      ],
      '2025-1-30':  [
        { t: 'تقرير خاص: دلالات الرموز ونوعية السلاح الذي غنمته المقاومة في جباليا', tag: 'تقرير خاص', img: 'assets/img/reports/special-3.webp', gov: 'غزة' }
      ],
      '2023-10-7':  [
  ...
  function renderHeroMap() {
    ...
    geo.features.forEach(function (f) {
      ...
      els.push(svg('path', {
        ...
        stroke: th.mode === 'dark' ? th.ink : th.accent, 'stroke-width': 0.7, 'stroke-opacity': 0.5
      }));
    });
    ...
    DATA.GOV.forEach(function (g, idx) {
      var x = px(g.lng), y = py(g.lat), c = g.gaza ? hot : (th.mode === 'dark' ? th.ink : th.accent);
    ...
    box.appendChild(svg('svg', { viewBox: '0 0 ' + W.toFixed(0) + ' ' + H.toFixed(0), class: 'hero-map__svg' }, els));
  }

  // أيقونات خطّية موحّدة (نفس السماكة/المقاس) لشريط مؤشّرات البطل
  function heroKpiIcon(name) {
    var P = {
      person: [['circle', { cx: 12, cy: 8, r: 3.2 }], ['path', { d: 'M5.6 19.4c0-3.6 2.9-6 6.4-6s6.4 2.4 6.4 6' }]],
      aid:    [['rect', { x: 4.5, y: 7.5, width: 15, height: 11, rx: 2.5 }], ['path', { d: 'M12 10.5v5' }], ['path', { d: 'M9.5 13h5' }]],
      lock:   [['rect', { x: 5.5, y: 10.5, width: 13, height: 8.5, rx: 2 }], ['path', { d: 'M8.5 10.5V8a3.5 3.5 0 0 1 7 0v2.5' }], ['circle', { cx: 12, cy: 14.6, r: 1.25 }]],
      house:  [['path', { d: 'M4 11.2l8-6 8 6' }], ['path', { d: 'M6 9.8v9.2h12V9.8' }]],
      flag:   [['path', { d: 'M6.6 4v16' }], ['path', { d: 'M6.6 5h10.6l-2.5 3.5 2.5 3.5H6.6' }]],
      target: [['circle', { cx: 12, cy: 12, r: 7.6 }], ['circle', { cx: 12, cy: 12, r: 3.7 }], ['circle', { cx: 12, cy: 12, r: 1, fill: 'currentColor', stroke: 'none' }]]
    };
    var kids = (P[name] || P.target).map(function (e) { return svg(e[0], e[1]); });
    return svg('svg', { viewBox: '0 0 24 24', class: 'hero-kpi__glyph', fill: 'none', stroke: 'currentColor',
      'stroke-width': 1.8, 'stroke-linecap': 'round', 'stroke-linejoin': 'round' }, kids);
  }
  ...
  function renderHeroKpis() {
    ...
    (DATA.heroKpis || []).forEach(function (k) {
      ...
      var icon = h('span', 'hero-kpi__icon'); icon.setAttribute('aria-hidden', 'true');
      cssVar(icon, '--tone', 'var(--' + k.tone + ')');
      icon.appendChild(heroKpiIcon(k.ic));
  ...
  // البطاقات الطافية = حصّة كل إقليم من النشاط المرصود (نِسَب مشتقّة من بيانات المحافظات
  // نفسها التي تصوّرها الخريطة). نعرض نِسَباً لا أعداداً مطلقة كي لا تتعارض مع الإجمالي
  // الموثّق المعتمد (434,505) المعروض في مواضع أخرى من الصفحة.
  function setHeroCards() {
    ...
    var tot = (wb + jeru + gaza) || 1;
    var share = { 'hero-wb': wb, 'hero-jeru': jeru, 'hero-gaza': gaza };
    Object.keys(share).forEach(function (key) {
      var el = $('[data-' + key + ']');
      if (el) el.textContent = (share[key] / tot * 100).toFixed(1) + '%';
    });
  }
  ...
  function renderTicker() {
    ...
    build(); build(); // نسختان للالتفاف السلس للماركيه (يعمل في كل الأحوال؛ الإيقاف عبر الزرّ)
  }
